...
class EvalWorker(BaseWorker):
    ...
    def _run(self) -> None:
        ...
        while True:
            ...
            if items_to_eval:
                selector_queue.put_many(eval_items(items_to_eval))
    ...
    #         last_board = memory_manager.get_node_board(
    #             item.node_name
    #         )  # TODO: pass board obj for optimization
    ...
    def evaluate(self, board: Board, is_check: bool) -> float32:
        """"""
